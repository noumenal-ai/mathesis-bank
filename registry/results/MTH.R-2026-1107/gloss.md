# MTH.R-2026-1107 — result `WMSpec.mixed_separation_of_monotone` [T0]

`theorem` in `WMSpec.MixedFamilies`; polarity universal. Discharges MTH.C-2026-1107. Kernel-verified (whole-theory replay); axioms ['propext', 'Classical.choice', 'Quot.sound'].

```
WMSpec.mixed_separation_of_monotone : ∀ {Θ : Type u_1} {Xd : Type u_2} {Yl : Type u_3} {ι : Type u_4} {k r : ℕ} {Lpred : Θ → Xd → List ι → ℕ}
